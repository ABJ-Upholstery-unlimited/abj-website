...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* SIDE DRAWER MENU */}
            <div className={clsx(
                "fixed top-0 right-0 h-screen w-3/4 max-w-sm bg-[#002244] z-[70] shadow-2xl transform transition-transform duration-300 ease-out md:hidden flex flex-col pt-24 px-8 border-l border-white/10",
